...
public class wwm 
{
	...
	public static int anzahl (boolean richtig, int anzahl_richtige_antworten)
	{
		if (richtig == true)
			anzahl_richtige_antworten++;
		
		return anzahl_richtige_antworten;
	}
	...
	//Anzahl richtiger Antworten bestimmen
			anzahl_richtige_antworten = anzahl (richtig, anzahl_richtige_antworten);
