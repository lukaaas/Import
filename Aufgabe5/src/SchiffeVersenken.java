...
{	
	...
	{
		/* Funktion um die Eingabe einer Ganzzahl zu erm?glichen, die zwischen 2 Werten liegt
	...
	public static void main(String[] args) 
	{
		...
		// Deklaration und Initialisierung eines zweidimensionalen Feldes mit der Bezeichnung nordsee als Spielfeld im Raster 6 x 6
		int [][] nordsee = new int [6][6];
		...
		/* Ein Beispiel f?r ein Spielfeld - es gibt keine direkt benachbarten Schiffe!
		 * 
		 *      0   1   2   3   4   5   
		 *  ===========================
		 *  0 | w | w | w | w | w | w | 
		...
		{
			// Per Zufallsfunktion werden f?r die Zeile und die Spalte Zahlen zwischen 0 und 5 ermittelt
			do
			{
				zeile = (int) (Math.random()*6);
				spalte = (int) (Math.random()*6);
			}
			// Es wird gepr?ft, ob an dieser Stelle des Spielfeldes ein Schiff platziert werden darf
			...
			// Jetzt m?ssen noch die Felder rund um das Schiff "gesperrt" werden, damit die Schiffe
			// nicht direkt aneinander sto?en - vertikal, horizontal und diagonal
			
			// Hier muss etwas eingetragen werden!!!!!	
		}
		
		// Schleife zur Abfrage der Felder, die darauf untersucht werden sollen, ob auf ihnen
